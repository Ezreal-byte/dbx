...
export default withEnglishFallback({
  ...
  connection: {
    ...
    sshUser: "Utente SSH",
    sshAuthMethod: "Metodo di autenticazione",
    ...
    sshKeySelectTitle: "Seleziona chiave privata SSH",
    sshWorkbenchHint: "Il workbench SSH riutilizza known_hosts, configurazione SSH, proxy e jump host di DBX. Le chiavi private sono referenziate tramite percorso locale e non vengono copiate in DBX.",
    sshKeepaliveHint: "Per impostazione predefinita il keepalive SSH viene inviato ogni 30 secondi e può essere modificato o disattivato per connessione. DBX non si disconnette solo per risposte keepalive mancanti.",
