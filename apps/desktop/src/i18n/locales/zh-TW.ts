...
export default withEnglishFallback({
  ...
  connection: {
    ...
    sshKeyPathBrowse: "瀏覽",
    sshKeySelectTitle: "選擇 SSH 私鑰",
    sshWorkbenchHint: "SSH 工作台會重用 DBX 的 known_hosts、SSH 設定、代理與跳板機處理。私鑰只引用本機路徑，不會複製到 DBX。",
    sshKeepaliveHint: "預設每 30 秒傳送 SSH 保活；可依連線修改或關閉。啟用後 DBX 不會因缺少保活回覆而主動中斷。",
