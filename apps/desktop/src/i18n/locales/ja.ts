...
export default withEnglishFallback({
  ...
  connection: {
    ...
    sshKeyPathBrowse: "参照",
    sshKeySelectTitle: "SSH 秘密鍵を選択",
    sshWorkbenchHint: "SSH ワークベンチは DBX の known_hosts、SSH 設定、プロキシ、踏み台ホスト処理を再利用します。秘密鍵はローカルパスで参照され、DBX にはコピーされません。",
    sshKeepaliveHint: "既定では 30 秒ごとに SSH keepalive を送信し、接続ごとに変更または無効化できます。keepalive 応答がないことだけを理由に DBX が切断することはありません。",
