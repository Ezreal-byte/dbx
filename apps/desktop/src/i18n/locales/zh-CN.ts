...
export default withEnglishFallback({
  ...
  connection: {
    ...
    sshKeyPathBrowse: "浏览",
    sshKeySelectTitle: "选择 SSH 私钥",
    sshWorkbenchHint: "SSH 工作台复用 DBX 的 known_hosts、SSH 配置、代理和跳板机处理。私钥仅引用本地路径，不会复制到 DBX。",
    sshKeepaliveHint: "默认每 30 秒发送 SSH 保活；可按连接修改或关闭。启用后 DBX 不会因缺少保活回包而主动断开。",
