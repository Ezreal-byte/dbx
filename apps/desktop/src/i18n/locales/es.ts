...
export default withEnglishFallback({
  ...
  connection: {
    ...
    sshUser: "Usuario SSH",
    sshAuthMethod: "Método de autenticación",
    ...
    sshKeySelectTitle: "Seleccionar clave privada SSH",
    sshWorkbenchHint: "El área de trabajo SSH reutiliza known_hosts, la configuración SSH, los proxies y los hosts de salto de DBX. Las claves privadas se referencian por su ruta local y no se copian en DBX.",
    sshKeepaliveHint: "De forma predeterminada se envía keepalive SSH cada 30 segundos y puede cambiarse o desactivarse por conexión. DBX no se desconectará únicamente por falta de respuestas keepalive.",
