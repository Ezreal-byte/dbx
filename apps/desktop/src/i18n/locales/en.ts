export default {
  ...
  connection: {
    ...
    sshKeySelectTitle: "Select SSH Private Key",
    sshWorkbenchHint: "The SSH workbench reuses DBX known_hosts, SSH config, proxy, and jump-host handling. Private keys are referenced by local path and are not copied into DBX.",
    sshKeepaliveHint: "SSH keepalive is sent every 30 seconds by default and can be changed or disabled per connection. DBX will not disconnect solely because keepalive replies are missing.",
