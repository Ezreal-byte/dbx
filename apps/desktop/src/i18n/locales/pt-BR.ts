...
export default withEnglishFallback({
  ...
  connection: {
    ...
    sshUser: "Usuário SSH",
    sshAuthMethod: "Método de autenticação",
    ...
    sshKeySelectTitle: "Selecionar chave privada SSH",
    sshWorkbenchHint: "O workbench SSH reutiliza known_hosts, configuração SSH, proxies e hosts de salto do DBX. As chaves privadas são referenciadas pelo caminho local e não são copiadas para o DBX.",
    sshKeepaliveHint: "Por padrão, o keepalive SSH é enviado a cada 30 segundos e pode ser alterado ou desativado por conexão. O DBX não se desconectará apenas pela ausência de respostas keepalive.",
