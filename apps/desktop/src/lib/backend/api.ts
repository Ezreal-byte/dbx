...
export const dockerCreateContainer = forward("dockerCreateContainer");
export const dockerApplyCompose = forward("dockerApplyCompose");
...
export const dockerLoadImage = forward("dockerLoadImage");
