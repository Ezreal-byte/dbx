...
export const sshTestConnection = forward("sshTestConnection");
export const sshCreateSession = forward("sshCreateSession");
export const sshConnectTerminal = forward("sshConnectTerminal");
export const sshCloseSession = forward("sshCloseSession");
export const sftpHome = forward("sftpHome");
export const sftpList = forward("sftpList");
export const sftpMkdir = forward("sftpMkdir");
export const sftpRename = forward("sftpRename");
export const sftpDelete = forward("sftpDelete");
export const sftpPreview = forward("sftpPreview");
export const pickSftpUploadFile = forward("pickSftpUploadFile");
export const sftpUpload = forward("sftpUpload");
export const sftpDownload = forward("sftpDownload");
export const listenSftpTransferProgress = forward("listenSftpTransferProgress");
export const cancelSftpTransfer = forward("cancelSftpTransfer");
