...
async fn main() {
    ...
    let api = Router::new()
        ...
        .route("/docker/networks/list", post(routes::docker::list_networks))
        .route("/docker/containers/action", post(routes::docker::container_action))
        ...
        .route("/docker/networks/create", post(routes::docker::create_network))
