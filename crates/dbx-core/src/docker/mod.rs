...
pub use service::{
    ...
    docker_export_image_bytes_core, docker_export_image_response_core, docker_export_image_to_path_core,
    ...
    docker_pull_image_response_core, docker_remove_container_core, docker_remove_image_core,
