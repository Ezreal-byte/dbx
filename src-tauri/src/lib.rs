...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::docker_cmd::docker_test_connection,
            commands::docker_cmd::docker_get_engine_details,
            commands::docker_cmd::docker_list_containers,
            commands::docker_cmd::docker_list_images,
            commands::docker_cmd::docker_list_volumes,
            commands::docker_cmd::docker_list_networks,
            commands::docker_cmd::docker_container_action,
            commands::docker_cmd::docker_inspect_container,
            commands::docker_cmd::docker_container_stats,
            commands::docker_cmd::docker_create_container,
            commands::docker_cmd::docker_apply_compose,
            commands::docker_cmd::docker_remove_container,
            commands::docker_cmd::docker_start_logs,
            commands::docker_cmd::docker_stop_stream,
            commands::docker_cmd::docker_list_container_files,
            commands::docker_cmd::docker_preview_container_file,
