...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ssh_workbench::ssh_test_connection,
            commands::ssh_workbench::ssh_create_session,
            commands::ssh_workbench::ssh_close_session,
            commands::ssh_workbench::ssh_terminal_server_port,
            commands::ssh_workbench::sftp_home,
            commands::ssh_workbench::sftp_list,
            commands::ssh_workbench::sftp_mkdir,
            commands::ssh_workbench::sftp_rename,
            commands::ssh_workbench::sftp_delete,
            commands::ssh_workbench::sftp_preview,
            commands::ssh_workbench::sftp_upload,
            commands::ssh_workbench::sftp_download,
            commands::ssh_workbench::listen_sftp_transfer_progress,
            commands::ssh_workbench::cancel_sftp_transfer,
